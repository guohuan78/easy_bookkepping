...
import com.eb.easy_bookkeeping.AboutActivity;
import com.eb.easy_bookkeeping.HistoryActivity;
import com.eb.easy_bookkeeping.MonthChartActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.dialog_more_btn_info:
                ...
                getContext().startActivity(intent);
                break;
            case R.id.dialog_more_btn_search:
